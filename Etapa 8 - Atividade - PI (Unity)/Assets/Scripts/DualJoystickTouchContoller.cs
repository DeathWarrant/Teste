...
public class DualJoystickTouchContoller : MonoBehaviour
{
    ...
    public Image leftJoystickBackgroundImage = null; // background image of the left joystick (the joystick's handle (knob) is a child of this image and moves along with it)
    public Image rightJoystickBackgroundImage = null; // background image of the right joystick (the joystick's handle (knob) is a child of this image and moves along with it)
    ...
    private Image leftJoystickHandleImage = null; // handle (knob) image of the left joystick
    private Image rightJoystickHandleImage = null; // handle (knob) image of the right joystick
    private LeftJoystick leftJoystick = null; // script component attached to the left joystick's background image
    private RightJoystick rightJoystick = null; // script component attached to the right joystick's background image
